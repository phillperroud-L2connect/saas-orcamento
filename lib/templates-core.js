 ...
 * segmento web designer exigem o plano `pro` (o mais caro dos dois planos).
 *
 * `pro` é o plano superior do catálogo de checkout (lib/planos.ts); estes três
 * templates são exclusivos dele. Planos inferiores ou status de pagamento
 * (`basico`, `manual`, `null`) não têm acesso — o gating nunca herda por padrão.
 */
export const TEMPLATES = {
  ...
  atelier_noir: { id: "atelier_noir", planoExigido: "pro", premium: true },
  blueprint_tecnico: {
    id: "blueprint_tecnico",
    planoExigido: "pro",
    premium: true,
  },
  swiss_studio: { id: "swiss_studio", planoExigido: "pro", premium: true },
};
...
/** Ids dos três templates premium exclusivos do plano Pro. */
export const TEMPLATES_PRO = [
  "atelier_noir",
  "blueprint_tecnico",
  "swiss_studio",
];
 ...
 *
 * Regra: template livre → sempre sim. Template que exige `pro` → só quem tem
 * `plano === "pro"`. Qualquer outro valor (`basico`, `manual`, nulo/desconhecido)
 * é tratado como SEM acesso ao premium — negar é o lado seguro e nunca herda.
 ...
 *
 * Se o tenant perder o plano Pro (downgrade, inadimplência) os orçamentos que
